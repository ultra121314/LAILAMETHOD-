...
# --- Configuration ---
bot = telebot.TeleBot('7500284327:AAGMW7jSJEs0jXOCgPlZeDr_A50zG3uasF8')
...
def generate_key(length=10):
    ...
    return f"Laila-MODS-{key.upper()}"  # Ensure key is in uppercase
...
def handle_attack(message):
    user_id = str(message.chat.id)
    cooldown_time = 150 # Cooldown in seconds (e.g., 60 seconds)
